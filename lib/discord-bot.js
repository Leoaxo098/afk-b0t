// ============================================================
//  lib/discord-bot.js  –  FINAL DEBUG + HARD LOCK VERSION
// ============================================================

require('dotenv').config();

console.log("📦 discord-bot.js LOADED");
...
// 🔒 HARD LOCK (prevents ANY duplicate start)
let started = false;
let client = null;
...
function startDiscordBot() {
    ...
    if (started) {
        console.log("⛔ startDiscordBot already called. Ignoring.");
        return;
    }
    started = true;

    // 🚫 BLOCK workers (extra safety)
    if (process.env.BOT_ID) {
        console.log("⛔ Worker process tried to start Discord bot");
        return;
    }
